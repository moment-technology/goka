//go:generate mockgen -self_package github.com/moment-technology/goka -package goka -destination mockstorage.go github.com/moment-technology/goka/storage Storage
//go:generate mockgen -self_package github.com/moment-technology/goka -package goka -destination mocks.go github.com/moment-technology/goka TopicManager,Producer,Broker
//go:generate mockgen -self_package github.com/moment-technology/goka -package goka -destination mockssarama.go github.com/IBM/sarama Client,ClusterAdmin
